...
{
    cpu->instructions[BRK_IMP].mode = mos6502_ImpMode;
    cpu->instructions[BRK_IMP].ucode = mos6502_BRK;

    cpu->instructions[ORA_XIdxInd].mode = mos6502_XIdxIndMode;
    cpu->instructions[ORA_XIdxInd].ucode = mos6502_ORA;

    cpu->instructions[ORA_ZPG].mode = mos6502_ZpgMode;
    cpu->instructions[ORA_ZPG].ucode = mos6502_ORA;

    cpu->instructions[ASL_ZPG].mode = mos6502_ZpgMode;
    cpu->instructions[ASL_ZPG].ucode = mos6502_ASL;

    cpu->instructions[PHP_IMP].mode = mos6502_ImpMode;
    cpu->instructions[PHP_IMP].ucode = mos6502_PHP;

    cpu->instructions[ORA_IMM].mode = mos6502_ImmMode;
    cpu->instructions[ORA_IMM].ucode = mos6502_ORA;

    cpu->instructions[ASL_ACC].mode = mos6502_AccMode;
    cpu->instructions[ASL_ACC].ucode = mos6502_ASL;
}
